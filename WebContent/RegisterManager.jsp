...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <form name="managerregistrationform">
        <fieldset>
        <legend> <h2> Manager Registration </h2></legend>
          ...
          <tr><td>Manager Name:</td><td><input type="text" name="mn" onkeypress="return onlyAlphabets(event,this,'nspan');"/><span id="nspan"></span></td></tr>   
          <tr><td>Email Id:</td><td><input type="text" id="meid" name="meid" onblur="emailValidity('meid','espan')"/><span id="espan"></span></td></tr>     
          <tr><td></td><td><input type="button" value="Register" onclick="managerRegisterMethod()"/></td></tr>
          <tr><td></td><td><span id="managerregistrationspan"></span></td></tr>
          </table>
          </fieldset>
         </form>
        </div>
