  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <h2>Upload Images</h2>
                <form name="uploadpicsform" method="post" action="UploadPicsServlet" enctype="multipart/form-data">
                <input type="file" name="picuploader"  id="picuploader" onclick="clear()"/>
                <input type="submit" value="upload" id="picuploadbt" />
                    
       <c:if test="${checkatt==1 }">
           <span style="color:green" id="area">${dataatt}</span>
       </c:if>
           <c:if test="${checkatt==0 }">
           <span style="color:red" id="area1">${dataatt}</span>
       </c:if>
    </form>  
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="UploadCareer.jsp">Updoad Carrier Things</a></li>
