  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <div class="round">
        <h2>Upload Career Information</h2>
        <form name="carrierform" action="UploadCareerServlet" method="post" enctype="multipart/form-data">
        Description:<input type="text" name="description" required="required" /><br/>
                <input type="file" name="carrier" required="required"/>
        <input type="submit" value="Upload" onclick="uploadCarrierJs()"/>
        <br/>
        <br/>
        <span id="carrerarea" style="color:green;">${responsetext}</span>
        </form>
        </div>
        </div>
      </div>
