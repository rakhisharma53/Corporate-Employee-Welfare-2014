    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <h2>Vacancy</h2>       
          <table  border="2">
          <tr>
             <th>JobTitle</th><th>Qualification</th><th>Experience</th><th>Total Vacancy</th><th>Package</th><th width="100px">Last Date</th><th></th>
         </tr>
             ...
             <c:forEach var="i" items="${viewvacancyatt}">
	           <tr>
				...
				<td>${i.package1}</td>
				<td>${i.date }</td>
				<td><a href="ModifyVacancyServlet?vid=${i.vacancyid }">Modify</a></td>
				</tr>
			</c:forEach>
        </table>
    </div>
