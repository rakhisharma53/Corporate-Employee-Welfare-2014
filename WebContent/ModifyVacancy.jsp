    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form name="addvacancyform"  method="post" action="">
        <fieldset>
        <legend> <h2> Modify Vacancy </h2></legend>
          <span id="addvacancyspan"></span>  
          <table>
          <tr><td>Job ID:</td><td><input type="text" name="jid" value="${vacancyatt.vacancyid }"/></td></tr>   
          <tr><td>Job Title:</td><td><input type="text" name="jtitle" value="${vacancyatt.jobtitle }"/><span id="tspan"></span></td></tr>   
          <tr><td>Qualification:</td><td><input type="text" name="qual" value="${vacancyatt.qualification }"/><span id="qspan"></span></td></tr>     
          <tr><td>Experience:</td><td><input type="text" name="exp" placeholder="enter in numerics" value="${vacancyatt.experience }"/><span id="espan"></span></td></tr>   
          <tr><td>No of vacancy:</td><td><input type="text" name="noofvac" value="${vacancyatt.noofvacancy}"/><span id="nspan"></span></td></tr>   
          <tr><td>Package:</td><td><input type="text" name="pkg" placeholder="enter in numerics" value="${vacancyatt.package1}"/><span id="pspan"></span></td></tr>
          <tr><td>Last Date:</td><td><input type="date" name="lastdate" value="${vacancyatt.date}"/><span id="dspan">yyyy-MM-dd</span></td></tr>
          <tr><td></td><td><input type="button" value="Modify" onclick="goingToModifyVacancyServletViaJS()"/></td>
