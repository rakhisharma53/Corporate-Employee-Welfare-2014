  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2>Event </h2>
            <div style="border:2px solid #a1a1a1; padding:10px 40px;background:#dddddd;width:550px;height:300pxborder-radius:25px;">
            <table>
            <tr><td>Title:</td><td>${eventatt.title}</td></tr>
            <tr><td>Venue:</td><td>${eventatt.venue}</td></tr>
            <tr><td>Date:</td><td>${eventatt.date}</td></tr>
            <tr><td>Time:</td><td>${eventatt.time}</td></tr>
            <tr><td>Duration:</td><td>${eventatt.duration}</td></tr>
            <tr></tr>
            <tr><td>Description:</td></tr>
            <tr><td></td><td>${eventatt.description}</td></tr>
