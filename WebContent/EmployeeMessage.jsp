    ...
    <form action="#" name="sendmessageform">
            <ol>
              ...
              <li>
                ...
                <input id="email" name="msgtit" class="text"  onblur='fill("email","tspan")' /><span id="tspan"></span>
              </li>
              <li>
                <label for="message">Message</label>
                <textarea id="message" name="msgdes" rows="8" cols="50"  onblur='fill("message","mspan")'></textarea><span id="mspan"></span>
              </li>
              <li>
