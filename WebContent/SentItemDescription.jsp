...
<body onload="goingToViewInboxServletViaJS()">
<div class="main">
  <div class="header">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar" class="fbg_resize">
           <div class="article" >
        <div style="border:5px solid #a1a1a1; padding:10px 40px;background:white;width:550px;border-radius:25px;color:black;">
       <h2>Sent Message</h2>
        <table>
        <tr><td>To: </td><td>${msgdescriptionatt.reciever}</td></tr>
