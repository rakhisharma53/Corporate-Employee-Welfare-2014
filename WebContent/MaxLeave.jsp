      ...
      <div class="mainbar">
        <div class="article">
           <span id="maxarea"></span>
             <div class="round">
             <form name="maxleaveform"  action="">
             <h2>Update Maximum number of Leaves</h2>
             <table>
             <tr><td>Maximum Leaves:</td><td><input type="text" name="maxleave"/></td></tr>
             <tr><td></td><td><input type="button" value="OK" onclick="maximumleaves()"/></td></tr>
             </table>
               </form>
             </div>
