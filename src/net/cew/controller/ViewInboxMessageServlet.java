...
public class ViewInboxMessageServlet extends HttpServlet 
{
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	  ...
	  mto=mdao.fetchMessageDescription(mto);
	  mdao.updateStatus(mto);

	  HttpSession session=request.getSession();
	  session.setAttribute("msgdescriptionatt",mto);
	  request.getRequestDispatcher("MessageDescription.jsp").forward(request, response);
	}
